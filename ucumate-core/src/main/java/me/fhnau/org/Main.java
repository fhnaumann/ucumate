...
public class Main {
    ...
    public static UCUMExpression visitTerm(String input) {
    ...
    public static UCUMExpression.CanonicalTerm visitCanonicalTerm(String input) {
        UCUMExpression UCUMExpression = visitTerm(input);
        Canonicalizer.CanonicalizationResult result = new Canonicalizer().canonicalize((UCUMExpression.Term) UCUMExpression);
...
//        }
        ...
        Converter.ConversionResult conversionResult = converter.convert(new Converter.Conversion(factor, (UCUMExpression.Term) visitTerm(unit1)), (UCUMExpression.Term) visitTerm(unit2));

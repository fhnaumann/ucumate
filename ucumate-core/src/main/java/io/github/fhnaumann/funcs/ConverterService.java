...
public interface ConverterService extends UcumVersioning, QuickParse {
     ...
     */
    public default ConverterService.ConversionResult convert(PreciseDecimal factor, String from, String to) {
        try {
     ...
     * @see UCUMService#convert(UCUMExpression.Term, UCUMExpression.Term)
     */
    public default ConverterService.ConversionResult convert(String factor, String from, String to) {
     ...
     * @see UCUMService#convert(UCUMExpression.Term, UCUMExpression.Term)
     */
    public default ConverterService.ConversionResult convert(String from, String to) {
     ...
     * @see UCUMService#convert(PreciseDecimal, UCUMExpression.Term, UCUMExpression.Term)
     */
    public default ConverterService.ConversionResult convert(UCUMExpression.Term from, UCUMExpression.Term to) {
        return convert(PreciseDecimal.ONE, from, to);
    }
     ...
     * @see UCUMService#convert(UCUMExpression.Term, UCUMExpression.Term)
     */
    public default ConverterService.ConversionResult convert(PreciseDecimal factor, UCUMExpression.Term from, UCUMExpression.Term to) {
     ...
     * @return A ConversionResult either containing the resulting conversion factor or an error with more details.
     */
    public default ConverterService.ConversionResult convert(String factor, String from, String to, String substanceMolMassCoeff) {
        /*
     ...
     * @return A ConversionResult either containing the resulting conversion factor or an error with more details.
     */
    public ConverterService.ConversionResult convert(PreciseDecimal factor, UCUMExpression.Term from, UCUMExpression.Term to, PreciseDecimal substanceMolMassCoeff);
     ...
     */
    sealed interface FailedConversion extends ConversionResult permits ConverterService.BaseDimensionMismatch, ConverterService.FailedCanonicalization, ValidatorService.ParserError {}

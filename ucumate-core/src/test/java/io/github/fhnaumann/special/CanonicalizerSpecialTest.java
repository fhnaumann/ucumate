...
public class CanonicalizerSpecialTest {
    ...
    public static void setUp() {
        canonicalizer = new Canonicalizer(new Printer(), new Validator());
    }

    @Test
    @DisplayName("")
    public void canonicalize_cf1_Cel() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(celsius_term());
    ...
    public void canonicalize_cf1_5_Cel() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(_5_celsius_term());
        assert_success(result, pd_u("278.15"), kelvin_term());
    }
    ...
    public void canonicalize_cf1_Mega_Cel() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(mega_celsius_term());
        assert_success(result, pd_u("1000273.15"), kelvin_term());
    }

    @Test
    public void canonicalize_cf1_5_Mega_Cel() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(_5_mega_celsius_term());
    ...
    public void canonicalize_cf1_degF() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(degF_term());
    ...
    public void canonicalize_cf1_5_degF() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(_5_degF_term());
        assert_success(result, pd_l("258.1500"), kelvin_term());
    }

    @Test
    public void canonicalize_cf1_prism_diopter() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(prism_diop_term());
        assert_success(result, pd_l("0.0100"), rad_term());
    }

    @Test
    public void canonicalize_cf1_5_prism_diopter() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(_5_prism_diop_term());
        assert_success(result, pd_l("0.0500"), rad_term());
    }

    @Test
    public void canonicalize_cf1_percent_slope() {
        CanonicalizerService.CanonicalizationResult result = canonicalizer.canonicalize(percentage_slope_term());

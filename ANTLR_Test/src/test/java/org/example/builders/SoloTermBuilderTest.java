...
public class SoloTermBuilderTest {
    ...
    public void term_is_no_prefix_simple_unit(UCUMDefinition.UCUMUnit unit) {
        ...
        assert_component_term_component_no_exponent_no_prefix_simple_unit_of(term)
                .extracting(Expression.SimpleUnit::ucumUnit)
                .isEqualTo(unit);
    }
    ...
    public void term_is_only_annotation_with_parens() {
        Expression.Term term = builder
                ...
                .asTerm()
                .build();
        assertThat(term).isInstanceOf(Expression.ParenTerm.class);
        assert_annot_only_term_of(((Expression.ParenTerm) term).term())
                .isEqualTo("abc");
    ...
    public void term_is_prefix_simple_unit_with_exponent_with_annotation_with_parens(UCUMDefinition.UCUMPrefix prefix, UCUMDefinition.UCUMUnit unit, int exponent, String annotation) {
        Expression.Term term = builder
                ...
                .asTerm().build();
        assertThat(term).isInstanceOf(Expression.ParenTerm.class);
        assert_term_is_prefix_simple_unit_with_exponent_with_annotation(((Expression.ParenTerm) term).term(),
                                                                        prefix,
                                                                        unit,
                                                                        exponent,
                                                                        annotation
    ...
    public void term_is_no_prefix_simple_unit_with_exponent_with_annotation_with_parens(UCUMDefinition.UCUMUnit unit, int exponent, String annotation) {
        Expression.Term term = builder
                ...
                .asTerm().build();
        assertThat(term).isInstanceOf(Expression.ParenTerm.class);
        assert_term_is_no_prefix_simple_unit_with_exponent_with_annotation(((Expression.ParenTerm) term).term(),
                                                                           unit,
                                                                           exponent,
                                                                           annotation
        );
    ...
    public void no_exp_no_annot_short_circuit_is_same_as_long_variant() {
        Expression.Term termUsingShortCircuit = builder
                .withIntegerUnit(5)
                .noExpNoAnnot()
                .asTerm().build();
        Expression.Term termUsingLongVariant = builder
                .withIntegerUnit(5)
                .asComponent()
                .withoutExponent()
                .withoutAnnotation()
